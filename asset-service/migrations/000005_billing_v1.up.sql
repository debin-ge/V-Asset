CREATE TABLE IF NOT EXISTS billing_accounts (
    ...
    available_balance_yuan BIGINT NOT NULL DEFAULT 0,
    reserved_balance_yuan BIGINT NOT NULL DEFAULT 0,
    total_recharged_yuan BIGINT NOT NULL DEFAULT 0,
    total_spent_yuan BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS billing_pricing (
    ...
    ingress_price_yuan_per_gb NUMERIC(20,8) NOT NULL,
    egress_price_yuan_per_gb NUMERIC(20,8) NOT NULL,
...
CREATE TABLE IF NOT EXISTS billing_charge_orders (
    ...
    held_amount_yuan BIGINT NOT NULL DEFAULT 0,
    captured_amount_yuan BIGINT NOT NULL DEFAULT 0,
    released_amount_yuan BIGINT NOT NULL DEFAULT 0,
    shortfall_yuan BIGINT NOT NULL DEFAULT 0,
    remark VARCHAR(255) NOT NULL DEFAULT '',
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    closed_at TIMESTAMP
...
CREATE TABLE IF NOT EXISTS billing_holds (
    ...
    status SMALLINT NOT NULL,
    amount_yuan BIGINT NOT NULL DEFAULT 0,
    captured_amount_yuan BIGINT NOT NULL DEFAULT 0,
    released_amount_yuan BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS traffic_usage_records (
    ...
    unit_price_yuan_per_gb NUMERIC(20,8) NOT NULL,
    amount_yuan BIGINT NOT NULL,
    pricing_version INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS billing_ledger_entries (
    ...
    scene SMALLINT NOT NULL,
    action_amount_yuan BIGINT NOT NULL DEFAULT 0,
    available_delta_yuan BIGINT NOT NULL DEFAULT 0,
    reserved_delta_yuan BIGINT NOT NULL DEFAULT 0,
    balance_after_available_yuan BIGINT NOT NULL,
    balance_after_reserved_yuan BIGINT NOT NULL,
