...
const file_proto_asset_proto_rawDesc = "" +
	...
	"\ffrozen_until\x18\x02 \x01(\tR\vfrozenUntil2\xc7\x12\n" +
	"\fAssetService\x12A\n" +
	"\n" +
...
var file_proto_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_proto_asset_proto_goTypes = []any{
	...
	(*AcquireProxyForTaskRequest)(nil),      // 28: asset.AcquireProxyForTaskRequest
	(*AcquireProxyForTaskResponse)(nil),     // 29: asset.AcquireProxyForTaskResponse
	...
	(*GetProxySourcePolicyRequest)(nil),     // 34: asset.GetProxySourcePolicyRequest
	(*GetProxySourcePolicyResponse)(nil),    // 35: asset.GetProxySourcePolicyResponse
	(*UpdateProxySourcePolicyRequest)(nil),  // 36: asset.UpdateProxySourcePolicyRequest
	(*UpdateProxySourcePolicyResponse)(nil), // 37: asset.UpdateProxySourcePolicyResponse
	(*ProxyInfo)(nil),                       // 38: asset.ProxyInfo
	(*ListProxiesRequest)(nil),              // 39: asset.ListProxiesRequest
	(*ListProxiesResponse)(nil),             // 40: asset.ListProxiesResponse
	(*CreateProxyRequest)(nil),              // 41: asset.CreateProxyRequest
	(*CreateProxyResponse)(nil),             // 42: asset.CreateProxyResponse
	(*UpdateProxyRequest)(nil),              // 43: asset.UpdateProxyRequest
	(*UpdateProxyResponse)(nil),             // 44: asset.UpdateProxyResponse
	(*UpdateProxyStatusRequest)(nil),        // 45: asset.UpdateProxyStatusRequest
	(*UpdateProxyStatusResponse)(nil),       // 46: asset.UpdateProxyStatusResponse
	(*DeleteProxyRequest)(nil),              // 47: asset.DeleteProxyRequest
	(*DeleteProxyResponse)(nil),             // 48: asset.DeleteProxyResponse
	(*CookieInfo)(nil),                      // 49: asset.CookieInfo
	(*CreateCookieRequest)(nil),             // 50: asset.CreateCookieRequest
	(*CreateCookieResponse)(nil),            // 51: asset.CreateCookieResponse
	(*UpdateCookieRequest)(nil),             // 52: asset.UpdateCookieRequest
	(*UpdateCookieResponse)(nil),            // 53: asset.UpdateCookieResponse
	(*DeleteCookieRequest)(nil),             // 54: asset.DeleteCookieRequest
	(*DeleteCookieResponse)(nil),            // 55: asset.DeleteCookieResponse
	(*GetCookieRequest)(nil),                // 56: asset.GetCookieRequest
	(*GetCookieResponse)(nil),               // 57: asset.GetCookieResponse
	(*ListCookiesRequest)(nil),              // 58: asset.ListCookiesRequest
	(*ListCookiesResponse)(nil),             // 59: asset.ListCookiesResponse
	(*GetAvailableCookieRequest)(nil),       // 60: asset.GetAvailableCookieRequest
	(*GetAvailableCookieResponse)(nil),      // 61: asset.GetAvailableCookieResponse
	(*ReportCookieUsageRequest)(nil),        // 62: asset.ReportCookieUsageRequest
	(*ReportCookieUsageResponse)(nil),       // 63: asset.ReportCookieUsageResponse
	(*FreezeCookieRequest)(nil),             // 64: asset.FreezeCookieRequest
	(*FreezeCookieResponse)(nil),            // 65: asset.FreezeCookieResponse
}
var file_proto_asset_proto_depIdxs = []int32{
	...
	38, // 4: asset.ListProxiesResponse.items:type_name -> asset.ProxyInfo
	49, // 5: asset.GetCookieResponse.cookie:type_name -> asset.CookieInfo
	49, // 6: asset.ListCookiesResponse.items:type_name -> asset.CookieInfo
	...
	5,  // 9: asset.AssetService.GetHistoryByTask:input_type -> asset.GetHistoryByTaskRequest
	7,  // 10: asset.AssetService.CheckQuota:input_type -> asset.CheckQuotaRequest
	9,  // 11: asset.AssetService.ConsumeQuota:input_type -> asset.ConsumeQuotaRequest
	11, // 12: asset.AssetService.RefundQuota:input_type -> asset.RefundQuotaRequest
	13, // 13: asset.AssetService.GetUserStats:input_type -> asset.GetUserStatsRequest
	17, // 14: asset.AssetService.GetPlatformStats:input_type -> asset.GetPlatformStatsRequest
	19, // 15: asset.AssetService.GetRequestTrend:input_type -> asset.GetRequestTrendRequest
	22, // 16: asset.AssetService.GetFileInfo:input_type -> asset.GetFileInfoRequest
	24, // 17: asset.AssetService.CreateHistory:input_type -> asset.CreateHistoryRequest
	26, // 18: asset.AssetService.UpdateHistoryStatus:input_type -> asset.UpdateHistoryStatusRequest
	28, // 19: asset.AssetService.AcquireProxyForTask:input_type -> asset.AcquireProxyForTaskRequest
	...
	34, // 22: asset.AssetService.GetProxySourcePolicy:input_type -> asset.GetProxySourcePolicyRequest
	36, // 23: asset.AssetService.UpdateProxySourcePolicy:input_type -> asset.UpdateProxySourcePolicyRequest
	39, // 24: asset.AssetService.ListProxies:input_type -> asset.ListProxiesRequest
	41, // 25: asset.AssetService.CreateProxy:input_type -> asset.CreateProxyRequest
	43, // 26: asset.AssetService.UpdateProxy:input_type -> asset.UpdateProxyRequest
	45, // 27: asset.AssetService.UpdateProxyStatus:input_type -> asset.UpdateProxyStatusRequest
	47, // 28: asset.AssetService.DeleteProxy:input_type -> asset.DeleteProxyRequest
	50, // 29: asset.AssetService.CreateCookie:input_type -> asset.CreateCookieRequest
	52, // 30: asset.AssetService.UpdateCookie:input_type -> asset.UpdateCookieRequest
	54, // 31: asset.AssetService.DeleteCookie:input_type -> asset.DeleteCookieRequest
	56, // 32: asset.AssetService.GetCookie:input_type -> asset.GetCookieRequest
	58, // 33: asset.AssetService.ListCookies:input_type -> asset.ListCookiesRequest
	60, // 34: asset.AssetService.GetAvailableCookie:input_type -> asset.GetAvailableCookieRequest
	62, // 35: asset.AssetService.ReportCookieUsage:input_type -> asset.ReportCookieUsageRequest
	64, // 36: asset.AssetService.FreezeCookie:input_type -> asset.FreezeCookieRequest
	1,  // 37: asset.AssetService.GetHistory:output_type -> asset.GetHistoryResponse
	4,  // 38: asset.AssetService.DeleteHistory:output_type -> asset.DeleteHistoryResponse
	6,  // 39: asset.AssetService.GetHistoryByTask:output_type -> asset.GetHistoryByTaskResponse
	8,  // 40: asset.AssetService.CheckQuota:output_type -> asset.CheckQuotaResponse
	10, // 41: asset.AssetService.ConsumeQuota:output_type -> asset.ConsumeQuotaResponse
	12, // 42: asset.AssetService.RefundQuota:output_type -> asset.RefundQuotaResponse
	14, // 43: asset.AssetService.GetUserStats:output_type -> asset.GetUserStatsResponse
	18, // 44: asset.AssetService.GetPlatformStats:output_type -> asset.GetPlatformStatsResponse
	21, // 45: asset.AssetService.GetRequestTrend:output_type -> asset.GetRequestTrendResponse
	23, // 46: asset.AssetService.GetFileInfo:output_type -> asset.GetFileInfoResponse
	25, // 47: asset.AssetService.CreateHistory:output_type -> asset.CreateHistoryResponse
	27, // 48: asset.AssetService.UpdateHistoryStatus:output_type -> asset.UpdateHistoryStatusResponse
	29, // 49: asset.AssetService.AcquireProxyForTask:output_type -> asset.AcquireProxyForTaskResponse
	31, // 50: asset.AssetService.GetAvailableProxy:output_type -> asset.GetAvailableProxyResponse
	33, // 51: asset.AssetService.ReportProxyUsage:output_type -> asset.ReportProxyUsageResponse
	35, // 52: asset.AssetService.GetProxySourcePolicy:output_type -> asset.GetProxySourcePolicyResponse
	37, // 53: asset.AssetService.UpdateProxySourcePolicy:output_type -> asset.UpdateProxySourcePolicyResponse
	40, // 54: asset.AssetService.ListProxies:output_type -> asset.ListProxiesResponse
	42, // 55: asset.AssetService.CreateProxy:output_type -> asset.CreateProxyResponse
	44, // 56: asset.AssetService.UpdateProxy:output_type -> asset.UpdateProxyResponse
	46, // 57: asset.AssetService.UpdateProxyStatus:output_type -> asset.UpdateProxyStatusResponse
	48, // 58: asset.AssetService.DeleteProxy:output_type -> asset.DeleteProxyResponse
	51, // 59: asset.AssetService.CreateCookie:output_type -> asset.CreateCookieResponse
	53, // 60: asset.AssetService.UpdateCookie:output_type -> asset.UpdateCookieResponse
	55, // 61: asset.AssetService.DeleteCookie:output_type -> asset.DeleteCookieResponse
	57, // 62: asset.AssetService.GetCookie:output_type -> asset.GetCookieResponse
	59, // 63: asset.AssetService.ListCookies:output_type -> asset.ListCookiesResponse
	61, // 64: asset.AssetService.GetAvailableCookie:output_type -> asset.GetAvailableCookieResponse
	63, // 65: asset.AssetService.ReportCookieUsage:output_type -> asset.ReportCookieUsageResponse
	65, // 66: asset.AssetService.FreezeCookie:output_type -> asset.FreezeCookieResponse
