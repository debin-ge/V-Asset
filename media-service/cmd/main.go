...
import (
	...
	dlcleanup "vasset/media-service/internal/download/cleanup"
	dlclient "vasset/media-service/internal/download/client"
	dlconfig "vasset/media-service/internal/download/config"
	dldatabase "vasset/media-service/internal/download/database"
	dlrepo "vasset/media-service/internal/download/repository"
	dlscheduler "vasset/media-service/internal/download/scheduler"
	dlstorage "vasset/media-service/internal/download/storage"
